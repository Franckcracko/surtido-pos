...
export class UserModel {
  static async create({ username, password, email }: { username: string, password: string, email: string }) {
  ...
  static async updatePassword({ id, newPassword }: { id: string, newPassword: string }) {
